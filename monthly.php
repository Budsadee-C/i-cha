    ...
    <div class="inbox">
    	 <div class="col-md-4 compose">
    	 	<div class="mail-profile">
              ...
              <h5 style="color:white;"><center><?php echo date("F");?></center></h5>
    	 		</div>
    	 	    <div class="clearfix"> </div>
    	 	</div>
    	 	...
    	 	<div class="tab-pane active text-style" id="tab1">
	    	 	<div class="mailbox-border">
	                <table class="table tab-border">
	                    <tbody>
	                        <tr class="unread checked" style="background: #64B88B;color:white;">
                          ...
                          <?php
                            SellMonthly();
                          ?>
                          <tr class="unread checked" style="background: #30D7EC;color:white;">
                              <td colspan = "1"></td>
                          ...
                          <tr>
                            <td colspan = "2"></td>
                            <td colspan = "2">
                                <a href="reportExcel.php?kind=monthly" class="hvr-icon-down"><i class="fa fa-download" aria-hidden="true"></i> ออกรายงาน</a>
                            </td>
                          </tr>
	                    </tbody>
	                </table>
