...
<div class="inner-block">
    <div class="inbox">
    	 	<div class="col-md-5 compose-right">
					<div class="inbox-details-default">
						<div class="alert alert-success">
							Add Customer
						</div>
						<div class="inbox-details-body">
							<form class="com-mail" method="post" action="newmember.php">
								<input type="text"  placeholder="ชื่อลูกค้า" name="namemember" id="namemember">
								<input type="text"  placeholder="รหัสพิน" name="pin">
							 <center><input type="submit" name="send" value="เพิ่มลูกค้า"></center>
							</form>
						</div>
					</div>
          <?php
          if ( isset( $_POST['send'] ) )
          {
            ...
            {?>
              <script type='text/javascript'>
                  ...
                  document.getElementById("namemember").focus();
              </script>
            <?php } // end else
        ...
        <div class="col-md-7 mailbox-content  tab-content tab-content-in">
           ...
           <div class="mailbox-border">
                   <table class="table tab-border">
                       <tbody>
                         <tr>
                             <td colspan = "2"></td>
                             <td colspan = "2">ตารางแสดงสมาชิกใหม่</td>
                          </tr>
                           <tr class="unread checked" style="background: #57A9E4;color:black;">
                               <td class="hidden-xs"></td>
                               <td>วันที่สมัคร</td>
                               <td>ชื่อลูกค้า</td>
                               <td>ยอดคะแนนคงเหลือ</td>
                           </tr>
                           <?php
                             queryAllCustomer();
                           ?>
        ...
        <!--<div class="col-md-7 compose">
          <div class="inbox-details-default">
            ...
            <div class="mailbox-border">
                    <table class="table tab-border">
                        <tbody>
                            <tr class="unread checked" style="background: #B0DCF5;color:black;">
                                <td class="hidden-xs"></td>
                                <td>วันที่สมัคร</td>
                                <td>ชื่อลูกค้า</td>
                                <td>ยอดคะแนนคงเหลือ</td>
