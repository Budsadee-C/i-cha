    	 ...
    	 <div class="col-md-4 compose">
    	 	<div class="mail-profile">
    	 		...
    	 		<div class="mailer-name">
    	 				<h5 style="color:white;"><center>Top 5 Menu Daily</center></h5>
    	 		</div>
    	 	    <div class="clearfix"> </div>
    	 	</div>
          ...
          <div class="mail-profile">
      	 		...
      	 		<div class="mailer-name">
      	 				<h5 style="color:white;"><center>Top 5 Topping Daily</center></h5>
      	 		</div>
      	 	    <div class="clearfix"> </div>
      	 	</div>
          <ul class="nav tabs">
            <?php queryTop5ToppingDaily();?>
         </ul>
    	 	...
    	 	<div class="tab-pane active text-style" id="tab1">
	    	 	<div class="mailbox-border">
	                <table class="table tab-border">
	                    <tbody>
	                        <tr class="unread checked" style="background: #E58673;color:white;">
                          ...
                          <tr>
                            <td colspan = "2"></td>
                            <td colspan = "2">
                                <a href="reportExcel.php?kind=daily" class="hvr-icon-down"><i class="fa fa-download" aria-hidden="true"></i> ออกรายงาน</a>
                            </td>
                          </tr>
	                    </tbody>
	                </table>
